...
################################################################################
## Form generated from reading UI file 'SystemMWQpPCNw.ui'
##
...
"border-bottom-right-radius:0px;")
        ...
        self.barraTitulo.setMinimumSize(QSize(0, 40))
...
"border-radius:0px;")
        icon = QIcon()
        icon.addFile(u"../img/loogo.PNG", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        self.horizontalLayout_2.setContentsMargins(3, 8, 0, 0)
...
"}")
        ...
        icon7 = QIcon()
        icon7.addFile(u"../img/24x24/cil-chevron-double-up-alt.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        icon8 = QIcon()
        icon8.addFile(u"../img/24x24/help_30px.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(u"../img/24x24/cil-user.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u"../img/website_50px.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u"../img/24x24/settings_30px.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon12 = QIcon()
        icon12.addFile(u"../img/money_50px.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon13 = QIcon()
        icon13.addFile(u"../img/24x24/admin_settings_male_30px.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon14 = QIcon()
        icon14.addFile(u"../img/edit_folder_24px.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.scrollArea_3 = QScrollArea(self.left_menu)
        self.scrollArea_3.setObjectName(u"scrollArea_3")
        self.scrollArea_3.setGeometry(QRect(330, 80, 120, 80))
        self.scrollArea_3.setWidgetResizable(True)
        self.scrollAreaWidgetContents_2 = QWidget()
        self.scrollAreaWidgetContents_2.setObjectName(u"scrollAreaWidgetContents_2")
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 120, 80))
        ...
        self.scrollAreaWidgetContents_Coins = QWidget()
        self.scrollAreaWidgetContents_Coins.setObjectName(u"scrollAreaWidgetContents_Coins")
        self.scrollAreaWidgetContents_Coins.setGeometry(QRect(0, 0, 944, 632))
        self.verticalLayout_13 = QVBoxLayout(self.scrollAreaWidgetContents_Coins)
        self.verticalLayout_13.setSpacing(0)
        self.verticalLayout_13.setObjectName(u"verticalLayout_13")
        self.verticalLayout_13.setContentsMargins(0, 0, 0, 0)
        self.stackedWidget = QStackedWidget(self.scrollAreaWidgetContents_Coins)
...
"")
        ...
        icon16 = QIcon()
        icon16.addFile(u"../img/search_30px.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon17 = QIcon()
        icon17.addFile(u"../img/24x24/cil-loop-circular.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        icon18 = QIcon()
        icon18.addFile(u"../img/microphone_50px.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon19 = QIcon()
        icon19.addFile(u"../img/24x24/cil-arrow-left.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon20 = QIcon()
        icon20.addFile(u"../img/24x24/cil-arrow-right.png", QSize(), QIcon.Normal, QIcon.Off)
...
"background-color: rgb(170, 85, 255);")
        ...
        self.frame_363.setMaximumSize(QSize(16777215, 200))
        ...
        self.scrollArea_6.setMaximumSize(QSize(16777215, 187))
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QRect(-835, 0, 1550, 182))
...
"")
        ...
        self.frame_Blender_3 = QFrame(self.scrollAreaWidgetContents_4)
        self.frame_Blender_3.setObjectName(u"frame_Blender_3")
        self.frame_Blender_3.setMinimumSize(QSize(250, 125))
        self.frame_Blender_3.setMaximumSize(QSize(250, 150))
        self.frame_Blender_3.setStyleSheet(u"background-color: rgb(255, 255, 255)\n"
"")
        self.frame_Blender_3.setFrameShape(QFrame.StyledPanel)
        self.frame_Blender_3.setFrameShadow(QFrame.Raised)
        self.Blender_lbl_3 = QLabel(self.frame_Blender_3)
        self.Blender_lbl_3.setObjectName(u"Blender_lbl_3")
        self.Blender_lbl_3.setGeometry(QRect(16, 100, 171, 30))
        font7 = QFont()
        font7.setPointSize(17)
        self.Blender_lbl_3.setFont(font7)
        self.Blender_lbl_3.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.Blender_btl_3 = QPushButton(self.frame_Blender_3)
        self.Blender_btl_3.setObjectName(u"Blender_btl_3")
        self.Blender_btl_3.setGeometry(QRect(13, 13, 90, 71))
        icon21 = QIcon()
        icon21.addFile(u"../img/web_100px.png", QSize(), QIcon.Normal, QIcon.Off)
        self.Blender_btl_3.setIcon(icon21)
        self.Blender_btl_3.setIconSize(QSize(100, 100))

        self.horizontalLayout_108.addWidget(self.frame_Blender_3)

        self.frame_Uity_2 = QFrame(self.scrollAreaWidgetContents_4)
        self.frame_Uity_2.setObjectName(u"frame_Uity_2")
        self.frame_Uity_2.setMinimumSize(QSize(250, 150))
        self.frame_Uity_2.setMaximumSize(QSize(250, 150))
        self.frame_Uity_2.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"\n"
"")
        self.frame_Uity_2.setFrameShape(QFrame.StyledPanel)
        self.frame_Uity_2.setFrameShadow(QFrame.Raised)
        self.unity_btn_2 = QPushButton(self.frame_Uity_2)
        self.unity_btn_2.setObjectName(u"unity_btn_2")
        self.unity_btn_2.setGeometry(QRect(13, 13, 90, 71))
        icon22 = QIcon()
        icon22.addFile(u"../img/close_pane_120px.png", QSize(), QIcon.Normal, QIcon.Off)
        self.unity_btn_2.setIcon(icon22)
        self.unity_btn_2.setIconSize(QSize(100, 100))
        self.Blender_lbl_4 = QLabel(self.frame_Uity_2)
        self.Blender_lbl_4.setObjectName(u"Blender_lbl_4")
        self.Blender_lbl_4.setGeometry(QRect(16, 100, 171, 30))
        font8 = QFont()
        font8.setPointSize(12)
        self.Blender_lbl_4.setFont(font8)
        self.Blender_lbl_4.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.horizontalLayout_108.addWidget(self.frame_Uity_2)

        self.frame_Gmail_2 = QFrame(self.scrollAreaWidgetContents_4)
        self.frame_Gmail_2.setObjectName(u"frame_Gmail_2")
        self.frame_Gmail_2.setMinimumSize(QSize(250, 150))
        self.frame_Gmail_2.setMaximumSize(QSize(250, 150))
        self.frame_Gmail_2.setStyleSheet(u"background-color: rgb(255, 255, 255);")
        self.frame_Gmail_2.setFrameShape(QFrame.StyledPanel)
        self.frame_Gmail_2.setFrameShadow(QFrame.Raised)
        self.gmail_btn_2 = QPushButton(self.frame_Gmail_2)
        self.gmail_btn_2.setObjectName(u"gmail_btn_2")
        self.gmail_btn_2.setGeometry(QRect(10, 17, 91, 71))
        icon23 = QIcon()
        icon23.addFile(u"../img/user_menu_female_120px.png", QSize(), QIcon.Normal, QIcon.Off)
        self.gmail_btn_2.setIcon(icon23)
        self.gmail_btn_2.setIconSize(QSize(115, 115))
        self.Blender_lbl_5 = QLabel(self.frame_Gmail_2)
        self.Blender_lbl_5.setObjectName(u"Blender_lbl_5")
        self.Blender_lbl_5.setGeometry(QRect(16, 100, 100, 30))
        self.Blender_lbl_5.setFont(font8)
        self.Blender_lbl_5.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.horizontalLayout_108.addWidget(self.frame_Gmail_2)

        self.frame_DirectWF_2 = QFrame(self.scrollAreaWidgetContents_4)
        self.frame_DirectWF_2.setObjectName(u"frame_DirectWF_2")
        self.frame_DirectWF_2.setMinimumSize(QSize(250, 150))
        self.frame_DirectWF_2.setMaximumSize(QSize(250, 150))
        self.frame_DirectWF_2.setStyleSheet(u"background-color: rgb(255, 255, 255)")
        self.frame_DirectWF_2.setFrameShape(QFrame.StyledPanel)
        self.frame_DirectWF_2.setFrameShadow(QFrame.Raised)
        self.directWF_btn_2 = QPushButton(self.frame_DirectWF_2)
        self.directWF_btn_2.setObjectName(u"directWF_btn_2")
        self.directWF_btn_2.setGeometry(QRect(13, 10, 90, 90))
        icon24 = QIcon()
        icon24.addFile(u"../img/instagram_logo_120px.png", QSize(), QIcon.Normal, QIcon.Off)
        self.directWF_btn_2.setIcon(icon24)
        self.directWF_btn_2.setIconSize(QSize(110, 130))
        self.lineEdit_2 = QLineEdit(self.frame_DirectWF_2)
...
"border:3px solid rgb(170, 85, 255)")
        ...
        self.Blender_lbl_6 = QLabel(self.frame_DirectWF_2)
        self.Blender_lbl_6.setObjectName(u"Blender_lbl_6")
        self.Blender_lbl_6.setGeometry(QRect(18, 101, 186, 30))
        self.Blender_lbl_6.setFont(font8)
        self.Blender_lbl_6.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.label_29 = QLabel(self.frame_DirectWF_2)
        self.label_29.setObjectName(u"label_29")
        self.label_29.setGeometry(QRect(60, 47, 114, 37))
        self.label_29.setStyleSheet(u"background-color: transparent;")

        self.horizontalLayout_108.addWidget(self.frame_DirectWF_2)
        ...
        icon25 = QIcon()
        icon25.addFile(u"../img/mac_client_50px.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.iconWindow_4.setPixmap(QPixmap(u"../img/ncicon.png"))
        ...
        icon26 = QIcon()
        icon26.addFile(u"../img/ibm_70px.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.verticalLayout_251.addWidget(self.scrollArea_6)
...
"border-radius:3px;")
        ...
        self.scrollAreaWidgetContents_Coins_2.setGeometry(QRect(0, 0, 936, 1830))
        ...
        self.frame_42.setStyleSheet(u"background-color: rgb(170, 85, 255);")
        self.frame_42.setFrameShape(QFrame.StyledPanel)
        self.frame_42.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_5 = QHBoxLayout(self.frame_42)
...
"border-radius:10px;")
        ...
        self.label_13.setPixmap(QPixmap(u"../img/exchange_bitcoinn_30px.png"))
...
"border-top-right-radius: 0px;")
        ...
        font11.setBold(True)
        self.bitcoin_lbl.setFont(font11)
        ...
        self.label_9.setPixmap(QPixmap(u"../img/bitcoin_50px.png"))
        ...
        font12.setBold(True)
        self.bitcoin_aoa_lbl.setFont(font12)
        ...
        self.frame_5 = QFrame(self.frame_42)
...
"}")
        ...
        self.bitcoin_LEdit.setFont(font12)
...
"}")
        ...
        self.bitcoin_aoa_LEdit.setFont(font12)
...
"}")
        ...
        self.frame_43.setStyleSheet(u"background-color: rgb(170, 85, 255);")
        ...
        self.frame_6 = QFrame(self.frame_43)
...
"border-radius:10px;")
        ...
        self.label_25.setPixmap(QPixmap(u"../img/synchronize_40px.png"))
        self.label_75 = QLabel(self.frame_29)
        self.label_75.setObjectName(u"label_75")
        self.label_75.setGeometry(QRect(10, 8, 20, 20))
        font14 = QFont()
        font14.setBold(True)
        self.label_75.setFont(font14)
...
"border-top-right-radius: 0px;")
        ...
        self.label_18.setPixmap(QPixmap(u"../img/round_50px.png"))
        ...
        self.dk_aoa_lbl.setFont(font12)
...
"border-radius:3px")
        ...
        self.frame_11 = QFrame(self.frame_43)
...
"}")
        ...
        self.DK_LEdit.setMinimumSize(QSize(190, 27))
        self.DK_LEdit.setMaximumSize(QSize(190, 27))
        self.DK_LEdit.setFont(font12)
...
"}")
        ...
        self.DK_aoa_LEdit.setMinimumSize(QSize(190, 27))
        self.DK_aoa_LEdit.setMaximumSize(QSize(190, 27))
        self.DK_aoa_LEdit.setFont(font12)
...
"}")
        ...
        self.horizontalLayout_12 = QHBoxLayout(self.frame_45)
        self.horizontalLayout_12.setSpacing(0)
        self.horizontalLayout_12.setObjectName(u"horizontalLayout_12")
        self.horizontalLayout_12.setContentsMargins(0, 0, 0, 0)
        self.frame_12 = QFrame(self.frame_45)
...
"border-radius:10px;")
        ...
        self.label_78.setPixmap(QPixmap(u"../img/synchronize_40px.png"))
...
"border-top-right-radius: 0px;")
        ...
        self.label_34.setPixmap(QPixmap(u"../img/round_50px.png"))
        ...
        self.frame_69 = QFrame(self.frame_45)
...
"}")
        ...
        self.DB_LEdit.setMinimumSize(QSize(190, 25))
        self.DB_LEdit.setMaximumSize(QSize(190, 25))
        self.DB_LEdit.setFont(font12)
...
"}")
        ...
        self.DB_aoa_LEdit.setMinimumSize(QSize(190, 25))
        self.DB_aoa_LEdit.setMaximumSize(QSize(190, 25))
        self.DB_aoa_LEdit.setFont(font12)
...
"}")
        ...
        self.frame_47.setStyleSheet(u"background-color: rgb(170, 85, 255);")
        self.frame_47.setFrameShape(QFrame.StyledPanel)
        self.frame_47.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_13 = QHBoxLayout(self.frame_47)
        self.horizontalLayout_13.setSpacing(0)
        self.horizontalLayout_13.setObjectName(u"horizontalLayout_13")
        self.horizontalLayout_13.setContentsMargins(0, 0, 0, 0)
        self.frame_17 = QFrame(self.frame_47)
...
"border-radius:10px;")
        ...
        self.label_80.setPixmap(QPixmap(u"../img/synchronize_40px.png"))
...
"border-top-right-radius: 0px;")
        ...
        self.label_37.setPixmap(QPixmap(u"../img/round_50px.png"))
...
"}")
        ...
        self.RO_LEdit.setMinimumSize(QSize(190, 25))
        self.RO_LEdit.setMaximumSize(QSize(190, 25))
        self.RO_LEdit.setFont(font12)
...
"}")
        ...
        self.RO_aoa_LEdit.setMinimumSize(QSize(190, 25))
        self.RO_aoa_LEdit.setMaximumSize(QSize(190, 25))
        self.RO_aoa_LEdit.setFont(font12)
...
"}")
        ...
        self.frame_48.setStyleSheet(u"background-color: rgb(170, 85, 255);")
        self.frame_48.setFrameShape(QFrame.StyledPanel)
        self.frame_48.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_14 = QHBoxLayout(self.frame_48)
        self.horizontalLayout_14.setSpacing(0)
        self.horizontalLayout_14.setObjectName(u"horizontalLayout_14")
        self.horizontalLayout_14.setContentsMargins(0, 0, 0, 0)
        self.frame_40 = QFrame(self.frame_48)
...
"border-radius:10px;")
        ...
        self.label_83.setPixmap(QPixmap(u"../img/synchronize_40px.png"))
...
"border-top-right-radius: 0px;")
        ...
        self.label_40.setPixmap(QPixmap(u"../img/round_50px.png"))
        ...
        self.frame_73 = QFrame(self.frame_48)
...
"}")
        ...
        self.DJ_LEdit.setMinimumSize(QSize(190, 25))
        self.DJ_LEdit.setMaximumSize(QSize(190, 25))
        self.DJ_LEdit.setFont(font12)
...
"}")
        ...
        self.DJ_aoa_LEdit.setMinimumSize(QSize(190, 25))
        self.DJ_aoa_LEdit.setMaximumSize(QSize(190, 25))
        self.DJ_aoa_LEdit.setFont(font12)
...
"}")
        ...
        self.verticalLayout_19.addWidget(self.frame_48)

        self.frame_46 = QFrame(self.frame_41)
        self.frame_46.setObjectName(u"frame_46")
        self.frame_46.setStyleSheet(u"background-color: rgb(170, 85, 255);")
...
"border-radius:10px;")
        ...
        self.label_162.setPixmap(QPixmap(u"../img/synchronize_40px.png"))
        self.label_163 = QLabel(self.frame_89)
        self.label_163.setObjectName(u"label_163")
        self.label_163.setGeometry(QRect(15, 9, 10, 20))
        self.label_163.setFont(font13)
...
"border-top-right-radius: 0px;")
        ...
        self.label_46.setPixmap(QPixmap(u"../img/round_50px.png"))
        ...
        self.frame_140 = QFrame(self.frame_46)
...
"}")
        ...
        self.DC_LEdit.setMinimumSize(QSize(190, 25))
        self.DC_LEdit.setMaximumSize(QSize(190, 25))
        self.DC_LEdit.setFont(font12)
...
"}")
        ...
        self.DC_aoa_LEdit.setMinimumSize(QSize(190, 25))
        self.DC_aoa_LEdit.setMaximumSize(QSize(190, 25))
        self.DC_aoa_LEdit.setFont(font12)
...
"}")
        ...
        self.frame_44.setStyleSheet(u"background-color: rgb(170, 85, 255);")
...
"border-radius:10px;")
        ...
        self.label_157.setPixmap(QPixmap(u"../img/synchronize_40px.png"))
...
"border-top-right-radius: 0px;")
        ...
        self.label_43.setPixmap(QPixmap(u"../img/round_50px.png"))
        ...
        self.frame_124 = QFrame(self.frame_44)
...
"}")
        ...
        self.LE_LEdit.setMinimumSize(QSize(190, 25))
        self.LE_LEdit.setMaximumSize(QSize(190, 25))
        self.LE_LEdit.setFont(font12)
...
"}")
        ...
        self.LE_aoa_LEdit.setMinimumSize(QSize(190, 25))
        self.LE_aoa_LEdit.setMaximumSize(QSize(190, 25))
        self.LE_aoa_LEdit.setFont(font12)
...
"}")
        ...
        self.frame_49.setStyleSheet(u"background-color: rgb(170, 85, 255);")
...
"border-radius:10px;")
        ...
        self.label_165.setPixmap(QPixmap(u"../img/synchronize_40px.png"))
        self.label_166 = QLabel(self.frame_91)
        self.label_166.setObjectName(u"label_166")
        self.label_166.setGeometry(QRect(13, 10, 10, 20))
        self.label_166.setFont(font13)
...
"border-top-right-radius: 0px;")
        ...
        self.frame_79 = QFrame(self.frame_49)
...
"}")
        ...
        self.E_LEdit.setMinimumSize(QSize(190, 25))
        self.E_LEdit.setMaximumSize(QSize(190, 25))
        self.E_LEdit.setFont(font12)
...
"}")
        ...
        self.E_aoa_LEdit.setMinimumSize(QSize(190, 25))
        self.E_aoa_LEdit.setMaximumSize(QSize(190, 25))
        self.E_aoa_LEdit.setFont(font12)
...
"}")
        ...
        self.frame_50 = QFrame(self.frame_41)
        self.frame_50.setObjectName(u"frame_50")
        self.frame_50.setStyleSheet(u"background-color: rgb(170, 85, 255);")
...
"border-radius:10px;")
        ...
        self.label_169.setPixmap(QPixmap(u"../img/synchronize_40px.png"))
...
"border-top-right-radius: 0px;")
        ...
        self.label_52.setPixmap(QPixmap(u"../img/round_50px.png"))
        ...
        self.frame_151 = QFrame(self.frame_50)
...
"}")
        ...
        self.FS_LEdit.setMinimumSize(QSize(190, 25))
        self.FS_LEdit.setMaximumSize(QSize(190, 25))
        self.FS_LEdit.setFont(font12)
...
"}")
        ...
        self.FS_aoa_LEdit.setMinimumSize(QSize(190, 25))
        self.FS_aoa_LEdit.setMaximumSize(QSize(190, 25))
        self.FS_aoa_LEdit.setFont(font12)
...
"}")
        ...
        self.frame_66 = QFrame(self.frame_41)
        self.frame_66.setObjectName(u"frame_66")
        self.frame_66.setStyleSheet(u"background-color: rgb(170, 85, 255);")
...
"border-radius:10px;")
        ...
        self.label_172.setPixmap(QPixmap(u"../img/synchronize_40px.png"))
...
"border-top-right-radius: 0px;")
        ...
        self.label_55.setPixmap(QPixmap(u"../img/round_50px.png"))
        ...
        self.frame_162 = QFrame(self.frame_66)
...
"}")
        ...
        self.DNA_LEdit.setMinimumSize(QSize(190, 25))
        self.DNA_LEdit.setMaximumSize(QSize(190, 25))
        self.DNA_LEdit.setFont(font12)
...
"}")
        ...
        self.DNA_uoa_LEdit = QLineEdit(self.frame_172)
        self.DNA_uoa_LEdit.setObjectName(u"DNA_uoa_LEdit")
        self.DNA_uoa_LEdit.setMinimumSize(QSize(190, 25))
        self.DNA_uoa_LEdit.setMaximumSize(QSize(190, 25))
        self.DNA_uoa_LEdit.setFont(font12)
        self.DNA_uoa_LEdit.setStyleSheet(u"QLineEdit{\n"
"	color: rgb(240, 240, 63);\n"
"	background-color: rgb(170, 85, 255);\n"
"	border-radius: 6px;\n"
"}\n"
...
"border: 2px solid rgb(90, 173, 253);\n"
"}")
        self.DNA_uoa_LEdit.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.horizontalLayout_60.addWidget(self.DNA_uoa_LEdit)
        ...
        self.verticalLayout_19.addWidget(self.frame_66)
        ...
        self.scrollArea_2.setWidget(self.scrollAreaWidgetContents_Coins)
...
"border-bottom-right-radius:15px;")
        ...
        self.scrollArea.setMaximumSize(QSize(16777215, 0))
        self.scrollArea.setStyleSheet(u"")
        self.scrollArea.setVerticalScrollBarPolicy(Qt.ScrollBarAsNeeded)
        self.scrollArea.setWidgetResizable(True)
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setObjectName(u"scrollAreaWidgetContents")
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 1472, 109))
...
"")
        ...
        self.frame_Blender = QFrame(self.scrollAreaWidgetContents)
        self.frame_Blender.setObjectName(u"frame_Blender")
        self.frame_Blender.setMinimumSize(QSize(90, 100))
        self.frame_Blender.setMaximumSize(QSize(90, 90))
        self.frame_Blender.setStyleSheet(u"background-color: rgb(170, 85, 255);\n"
"")
        self.frame_Blender.setFrameShape(QFrame.StyledPanel)
        self.frame_Blender.setFrameShadow(QFrame.Raised)
        self.Blender_lbl = QLabel(self.frame_Blender)
        self.Blender_lbl.setObjectName(u"Blender_lbl")
        self.Blender_lbl.setGeometry(QRect(10, 70, 60, 20))
        self.Blender_lbl.setFont(font8)
        self.Blender_lbl.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.Blender_btl = QPushButton(self.frame_Blender)
        self.Blender_btl.setObjectName(u"Blender_btl")
        self.Blender_btl.setGeometry(QRect(10, 10, 40, 40))
        icon27 = QIcon()
        icon27.addFile(u"../img/blender_3d_40px.png", QSize(), QIcon.Normal, QIcon.Off)
        self.Blender_btl.setIcon(icon27)
        self.Blender_btl.setIconSize(QSize(40, 40))

        self.horizontalLayout.addWidget(self.frame_Blender)

        self.frame_Unity = QFrame(self.scrollAreaWidgetContents)
        self.frame_Unity.setObjectName(u"frame_Unity")
        self.frame_Unity.setMinimumSize(QSize(90, 100))
        self.frame_Unity.setMaximumSize(QSize(90, 90))
        self.frame_Unity.setStyleSheet(u"background-color: rgb(170, 85, 255);\n"
"\n"
"")
        self.frame_Unity.setFrameShape(QFrame.StyledPanel)
        self.frame_Unity.setFrameShadow(QFrame.Raised)
        self.unity_btn = QPushButton(self.frame_Unity)
        self.unity_btn.setObjectName(u"unity_btn")
        self.unity_btn.setGeometry(QRect(10, 10, 40, 40))
        icon28 = QIcon()
        icon28.addFile(u"../img/unity_40px.png", QSize(), QIcon.Normal, QIcon.Off)
        self.unity_btn.setIcon(icon28)
        self.unity_btn.setIconSize(QSize(40, 40))
        self.unity_lbl = QLabel(self.frame_Unity)
        self.unity_lbl.setObjectName(u"unity_lbl")
        self.unity_lbl.setGeometry(QRect(10, 70, 40, 20))
        self.unity_lbl.setFont(font8)
        self.unity_lbl.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.horizontalLayout.addWidget(self.frame_Unity)

        self.frame_Gmail = QFrame(self.scrollAreaWidgetContents)
        self.frame_Gmail.setObjectName(u"frame_Gmail")
        self.frame_Gmail.setMinimumSize(QSize(90, 100))
        self.frame_Gmail.setMaximumSize(QSize(90, 90))
        self.frame_Gmail.setStyleSheet(u"background-color: rgb(170, 85, 255);")
        self.frame_Gmail.setFrameShape(QFrame.StyledPanel)
        self.frame_Gmail.setFrameShadow(QFrame.Raised)
        self.gmail_lbl = QLabel(self.frame_Gmail)
        self.gmail_lbl.setObjectName(u"gmail_lbl")
        self.gmail_lbl.setGeometry(QRect(10, 70, 80, 20))
        self.gmail_lbl.setFont(font8)
        self.gmail_lbl.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.gmail_btn = QPushButton(self.frame_Gmail)
        self.gmail_btn.setObjectName(u"gmail_btn")
        self.gmail_btn.setGeometry(QRect(10, 17, 40, 30))
        icon29 = QIcon()
        icon29.addFile(u"../img/gmail_logo_40px.png", QSize(), QIcon.Normal, QIcon.Off)
        self.gmail_btn.setIcon(icon29)
        self.gmail_btn.setIconSize(QSize(40, 40))

        self.horizontalLayout.addWidget(self.frame_Gmail)

        self.frame_Bing = QFrame(self.scrollAreaWidgetContents)
        self.frame_Bing.setObjectName(u"frame_Bing")
        self.frame_Bing.setMinimumSize(QSize(90, 100))
        self.frame_Bing.setMaximumSize(QSize(90, 90))
        self.frame_Bing.setStyleSheet(u"background-color: rgb(170, 85, 255);")
        self.frame_Bing.setFrameShape(QFrame.StyledPanel)
        self.frame_Bing.setFrameShadow(QFrame.Raised)
        self.bing_lbl = QLabel(self.frame_Bing)
        self.bing_lbl.setObjectName(u"bing_lbl")
        self.bing_lbl.setGeometry(QRect(13, 70, 40, 20))
        self.bing_lbl.setFont(font8)
        self.bing_lbl.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.bing_btn = QPushButton(self.frame_Bing)
        self.bing_btn.setObjectName(u"bing_btn")
        self.bing_btn.setGeometry(QRect(10, 10, 40, 40))
        icon30 = QIcon()
        icon30.addFile(u"../img/bing_40px.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bing_btn.setIcon(icon30)
        self.bing_btn.setIconSize(QSize(40, 40))

        self.horizontalLayout.addWidget(self.frame_Bing)

        self.frame_HBOgo = QFrame(self.scrollAreaWidgetContents)
        self.frame_HBOgo.setObjectName(u"frame_HBOgo")
        self.frame_HBOgo.setMinimumSize(QSize(90, 100))
        self.frame_HBOgo.setMaximumSize(QSize(90, 90))
        self.frame_HBOgo.setStyleSheet(u"background-color: rgb(170, 85, 255);")
        self.frame_HBOgo.setFrameShape(QFrame.StyledPanel)
        self.frame_HBOgo.setFrameShadow(QFrame.Raised)
        self.hboGo_lbl = QLabel(self.frame_HBOgo)
        self.hboGo_lbl.setObjectName(u"hboGo_lbl")
        self.hboGo_lbl.setGeometry(QRect(10, 70, 80, 20))
        self.hboGo_lbl.setFont(font8)
        self.hboGo_lbl.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.hboGo_btn = QPushButton(self.frame_HBOgo)
        self.hboGo_btn.setObjectName(u"hboGo_btn")
        self.hboGo_btn.setGeometry(QRect(10, 11, 40, 40))
        icon31 = QIcon()
        icon31.addFile(u"../img/hbo_go_53px.png", QSize(), QIcon.Normal, QIcon.Off)
        self.hboGo_btn.setIcon(icon31)
        self.hboGo_btn.setIconSize(QSize(53, 53))

        self.horizontalLayout.addWidget(self.frame_HBOgo)

        self.frame_Source = QFrame(self.scrollAreaWidgetContents)
        self.frame_Source.setObjectName(u"frame_Source")
        self.frame_Source.setMinimumSize(QSize(90, 100))
        self.frame_Source.setMaximumSize(QSize(90, 90))
        self.frame_Source.setStyleSheet(u"background-color: rgb(170, 85, 255);")
        self.frame_Source.setFrameShape(QFrame.StyledPanel)
        self.frame_Source.setFrameShadow(QFrame.Raised)
        self.source_lbl = QLabel(self.frame_Source)
        self.source_lbl.setObjectName(u"source_lbl")
        self.source_lbl.setGeometry(QRect(10, 70, 80, 20))
        self.source_lbl.setFont(font8)
        self.source_lbl.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.source_btn = QPushButton(self.frame_Source)
        self.source_btn.setObjectName(u"source_btn")
        self.source_btn.setGeometry(QRect(10, 10, 40, 40))
        icon32 = QIcon()
        icon32.addFile(u"../img/open_source_50px.png", QSize(), QIcon.Normal, QIcon.Off)
        self.source_btn.setIcon(icon32)
        self.source_btn.setIconSize(QSize(48, 48))

        self.horizontalLayout.addWidget(self.frame_Source)

        self.frame_Electron = QFrame(self.scrollAreaWidgetContents)
        self.frame_Electron.setObjectName(u"frame_Electron")
        self.frame_Electron.setMinimumSize(QSize(90, 100))
        self.frame_Electron.setMaximumSize(QSize(90, 90))
        self.frame_Electron.setStyleSheet(u"background-color: rgb(170, 85, 255);")
        self.frame_Electron.setFrameShape(QFrame.StyledPanel)
        self.frame_Electron.setFrameShadow(QFrame.Raised)
        self.electron_lbl = QLabel(self.frame_Electron)
        self.electron_lbl.setObjectName(u"electron_lbl")
        self.electron_lbl.setGeometry(QRect(10, 70, 80, 20))
        self.electron_lbl.setFont(font8)
        self.electron_lbl.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.electron_btn = QPushButton(self.frame_Electron)
        self.electron_btn.setObjectName(u"electron_btn")
        self.electron_btn.setGeometry(QRect(10, 10, 40, 40))
        icon33 = QIcon()
        icon33.addFile(u"../img/electronics_50px.png", QSize(), QIcon.Normal, QIcon.Off)
        self.electron_btn.setIcon(icon33)
        self.electron_btn.setIconSize(QSize(40, 40))

        self.horizontalLayout.addWidget(self.frame_Electron)

        self.frame_DropBox = QFrame(self.scrollAreaWidgetContents)
        self.frame_DropBox.setObjectName(u"frame_DropBox")
        self.frame_DropBox.setMinimumSize(QSize(90, 100))
        self.frame_DropBox.setMaximumSize(QSize(90, 90))
        self.frame_DropBox.setStyleSheet(u"background-color: rgb(170, 85, 255);")
        self.frame_DropBox.setFrameShape(QFrame.StyledPanel)
        self.frame_DropBox.setFrameShadow(QFrame.Raised)
        self.dropBox_lbl = QLabel(self.frame_DropBox)
        self.dropBox_lbl.setObjectName(u"dropBox_lbl")
        self.dropBox_lbl.setGeometry(QRect(10, 70, 80, 20))
        self.dropBox_lbl.setFont(font8)
        self.dropBox_lbl.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.dropBox_btn = QPushButton(self.frame_DropBox)
        self.dropBox_btn.setObjectName(u"dropBox_btn")
        self.dropBox_btn.setGeometry(QRect(10, 10, 40, 40))
        icon34 = QIcon()
        icon34.addFile(u"../img/dropbox_50px.png", QSize(), QIcon.Normal, QIcon.Off)
        self.dropBox_btn.setIcon(icon34)
        self.dropBox_btn.setIconSize(QSize(40, 40))

        self.horizontalLayout.addWidget(self.frame_DropBox)

        self.frame_raspberry = QFrame(self.scrollAreaWidgetContents)
        self.frame_raspberry.setObjectName(u"frame_raspberry")
        self.frame_raspberry.setMinimumSize(QSize(90, 100))
        self.frame_raspberry.setMaximumSize(QSize(90, 90))
        self.frame_raspberry.setStyleSheet(u"background-color: rgb(170, 85, 255);")
        self.frame_raspberry.setFrameShape(QFrame.StyledPanel)
        self.frame_raspberry.setFrameShadow(QFrame.Raised)
        self.raspberry_lbl = QLabel(self.frame_raspberry)
        self.raspberry_lbl.setObjectName(u"raspberry_lbl")
        self.raspberry_lbl.setGeometry(QRect(10, 70, 80, 20))
        self.raspberry_lbl.setFont(font8)
        self.raspberry_lbl.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.raspberry_btn = QPushButton(self.frame_raspberry)
        self.raspberry_btn.setObjectName(u"raspberry_btn")
        self.raspberry_btn.setGeometry(QRect(10, 10, 40, 40))
        self.raspberry_btn.setStyleSheet(u"")
        icon35 = QIcon()
        icon35.addFile(u"../img/raspberry_pi_50px.png", QSize(), QIcon.Normal, QIcon.Off)
        self.raspberry_btn.setIcon(icon35)
        self.raspberry_btn.setIconSize(QSize(50, 50))

        self.horizontalLayout.addWidget(self.frame_raspberry)

        self.frame_Android = QFrame(self.scrollAreaWidgetContents)
        self.frame_Android.setObjectName(u"frame_Android")
        self.frame_Android.setMinimumSize(QSize(90, 100))
        self.frame_Android.setMaximumSize(QSize(90, 90))
        self.frame_Android.setStyleSheet(u"background-color: rgb(170, 85, 255);")
        self.frame_Android.setFrameShape(QFrame.StyledPanel)
        self.frame_Android.setFrameShadow(QFrame.Raised)
        self.android_lbl = QLabel(self.frame_Android)
        self.android_lbl.setObjectName(u"android_lbl")
        self.android_lbl.setGeometry(QRect(10, 70, 80, 20))
        self.android_lbl.setFont(font8)
        self.android_lbl.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.android_btn = QPushButton(self.frame_Android)
        self.android_btn.setObjectName(u"android_btn")
        self.android_btn.setGeometry(QRect(10, 10, 40, 41))
        self.android_btn.setStyleSheet(u"")
        icon36 = QIcon()
        icon36.addFile(u"../img/android_os_50px.png", QSize(), QIcon.Normal, QIcon.Off)
        self.android_btn.setIcon(icon36)
        self.android_btn.setIconSize(QSize(50, 50))

        self.horizontalLayout.addWidget(self.frame_Android)

        self.frame_DirectWF = QFrame(self.scrollAreaWidgetContents)
        self.frame_DirectWF.setObjectName(u"frame_DirectWF")
        self.frame_DirectWF.setMinimumSize(QSize(90, 100))
        self.frame_DirectWF.setMaximumSize(QSize(90, 90))
        self.frame_DirectWF.setStyleSheet(u"background-color: rgb(170, 85, 255);")
        self.frame_DirectWF.setFrameShape(QFrame.StyledPanel)
        self.frame_DirectWF.setFrameShadow(QFrame.Raised)
        self.directWF_lbl = QLabel(self.frame_DirectWF)
        self.directWF_lbl.setObjectName(u"directWF_lbl")
        self.directWF_lbl.setGeometry(QRect(10, 70, 80, 20))
        self.directWF_lbl.setFont(font8)
        self.directWF_lbl.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.directWF_btn = QPushButton(self.frame_DirectWF)
        self.directWF_btn.setObjectName(u"directWF_btn")
        self.directWF_btn.setGeometry(QRect(10, 10, 50, 50))
        icon37 = QIcon()
        icon37.addFile(u"../img/wi-fi_direct_60px.png", QSize(), QIcon.Normal, QIcon.Off)
        self.directWF_btn.setIcon(icon37)
        self.directWF_btn.setIconSize(QSize(60, 60))

        self.horizontalLayout.addWidget(self.frame_DirectWF, 0, Qt.AlignRight)

        self.frame_IOs = QFrame(self.scrollAreaWidgetContents)
        self.frame_IOs.setObjectName(u"frame_IOs")
        self.frame_IOs.setMinimumSize(QSize(90, 100))
        self.frame_IOs.setMaximumSize(QSize(90, 90))
        self.frame_IOs.setStyleSheet(u"background-color: rgb(170, 85, 255);")
        self.frame_IOs.setFrameShape(QFrame.StyledPanel)
        self.frame_IOs.setFrameShadow(QFrame.Raised)
        self.ios_lbl = QLabel(self.frame_IOs)
        self.ios_lbl.setObjectName(u"ios_lbl")
        self.ios_lbl.setGeometry(QRect(14, 70, 70, 20))
        self.ios_lbl.setFont(font8)
        self.ios_lbl.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.ios_btn = QPushButton(self.frame_IOs)
        self.ios_btn.setObjectName(u"ios_btn")
        self.ios_btn.setGeometry(QRect(7, 7, 50, 50))
        self.ios_btn.setIcon(icon25)
        self.ios_btn.setIconSize(QSize(60, 60))

        self.horizontalLayout.addWidget(self.frame_IOs)

        self.frame_IBM = QFrame(self.scrollAreaWidgetContents)
        self.frame_IBM.setObjectName(u"frame_IBM")
        self.frame_IBM.setMinimumSize(QSize(90, 100))
        self.frame_IBM.setMaximumSize(QSize(90, 90))
        self.frame_IBM.setStyleSheet(u"background-color: rgb(170, 85, 255);")
        self.frame_IBM.setFrameShape(QFrame.StyledPanel)
        self.frame_IBM.setFrameShadow(QFrame.Raised)
        self.ibm_lbl = QLabel(self.frame_IBM)
        self.ibm_lbl.setObjectName(u"ibm_lbl")
        self.ibm_lbl.setGeometry(QRect(10, 70, 80, 20))
        self.ibm_lbl.setFont(font8)
        self.ibm_lbl.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.ibm_btn = QPushButton(self.frame_IBM)
        self.ibm_btn.setObjectName(u"ibm_btn")
        self.ibm_btn.setGeometry(QRect(10, 15, 50, 30))
        self.ibm_btn.setIcon(icon26)
        self.ibm_btn.setIconSize(QSize(50, 50))

        self.horizontalLayout.addWidget(self.frame_IBM)

        self.frame_Tesla = QFrame(self.scrollAreaWidgetContents)
        self.frame_Tesla.setObjectName(u"frame_Tesla")
        self.frame_Tesla.setMinimumSize(QSize(90, 100))
        self.frame_Tesla.setMaximumSize(QSize(90, 90))
        self.frame_Tesla.setStyleSheet(u"background-color: rgb(170, 85, 255);")
        self.frame_Tesla.setFrameShape(QFrame.StyledPanel)
        self.frame_Tesla.setFrameShadow(QFrame.Raised)
        self.tesla_lbl = QLabel(self.frame_Tesla)
        self.tesla_lbl.setObjectName(u"tesla_lbl")
        self.tesla_lbl.setGeometry(QRect(10, 70, 80, 20))
        self.tesla_lbl.setFont(font8)
        self.tesla_lbl.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.tesla_btn = QPushButton(self.frame_Tesla)
        self.tesla_btn.setObjectName(u"tesla_btn")
        self.tesla_btn.setGeometry(QRect(10, 10, 40, 40))
        icon38 = QIcon()
        icon38.addFile(u"../img/tesla_70px.png", QSize(), QIcon.Normal, QIcon.Off)
        self.tesla_btn.setIcon(icon38)
        self.tesla_btn.setIconSize(QSize(40, 40))

        self.horizontalLayout.addWidget(self.frame_Tesla)

        self.frame_Helpe = QFrame(self.scrollAreaWidgetContents)
        self.frame_Helpe.setObjectName(u"frame_Helpe")
        self.frame_Helpe.setMinimumSize(QSize(90, 100))
        self.frame_Helpe.setMaximumSize(QSize(90, 90))
        ...
        icon39 = QIcon()
        icon39.addFile(u"../img/help_70px.png", QSize(), QIcon.Normal, QIcon.Off)
        self.help_btnF_2.setIcon(icon39)
    ...
    def retranslateUi(self, MainWindowMW):
        ...
        self.NameEmp.setText(QCoreApplication.translate("MainWindowMW", u"Tech Nd", None))
...
#if QT_CONFIG(whatsthis)
        self.Blender_lbl_3.setWhatsThis(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><br/></p><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.Blender_lbl_3.setText(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><span style=\" font-family:'inherit'; color:#aa55ff;\">Browsing history</span></p></body></html>", None))
#if QT_CONFIG(whatsthis)
        self.Blender_btl_3.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.Blender_btl_3.setText("")
#if QT_CONFIG(whatsthis)
        self.unity_btn_2.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.unity_btn_2.setText("")
#if QT_CONFIG(whatsthis)
        self.Blender_lbl_4.setWhatsThis(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><br/></p><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.Blender_lbl_4.setText(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><span style=\" font-family:'inherit'; font-size:18pt; color:#aa55ff;\">Opening history</span></p></body></html>", None))
#if QT_CONFIG(whatsthis)
        self.gmail_btn_2.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.gmail_btn_2.setText("")
#if QT_CONFIG(whatsthis)
        self.Blender_lbl_5.setWhatsThis(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><br/></p><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.Blender_lbl_5.setText(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><span style=\" font-family:'inherit'; font-size:18pt; color:#aa55ff;\">User list</span></p></body></html>", None))
#if QT_CONFIG(whatsthis)
        self.directWF_btn_2.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.directWF_btn_2.setText("")
        self.lineEdit_2.setText(QCoreApplication.translate("MainWindowMW", u"123456789", None))
#if QT_CONFIG(whatsthis)
        self.Blender_lbl_6.setWhatsThis(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><br/></p><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.Blender_lbl_6.setText(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><span style=\" font-family:'inherit'; font-size:18pt; color:#aa55ff;\">Password face id </span></p></body></html>", None))
        ...
        self.data_bitcoins.setText(QCoreApplication.translate("MainWindowMW", u"Quotation date: 01/09/20022", None))
        ...
        self.data_dk.setText(QCoreApplication.translate("MainWindowMW", u"Quotation date: 01/09/20022", None))
        ...
        self.label_36.setText(QCoreApplication.translate("MainWindowMW", u"Quotation date: 01/09/20022", None))
        ...
        self.label_42.setText(QCoreApplication.translate("MainWindowMW", u"Quotation date: 01/09/20022", None))
        ...
        self.label_48.setText(QCoreApplication.translate("MainWindowMW", u"Quotation date: 01/09/20022", None))
        ...
        self.label_60.setText(QCoreApplication.translate("MainWindowMW", u"Quotation date: 01/09/20022", None))
        ...
        self.label_54.setText(QCoreApplication.translate("MainWindowMW", u"Quotation date: 01/09/20022", None))
        ...
        self.label_66.setText(QCoreApplication.translate("MainWindowMW", u"Quotation date: 01/09/20022", None))
        ...
        self.label_72.setText(QCoreApplication.translate("MainWindowMW", u"Quotation date: 01/09/20022", None))
        ...
        self.label_76.setText(QCoreApplication.translate("MainWindowMW", u"Quotation date: 01/09/20022", None))
        ...
        self.DNA_uoa_LEdit.setText(QCoreApplication.translate("MainWindowMW", u"428,58", None))
        self.label_183.setText(QCoreApplication.translate("MainWindowMW", u"AOA", None))
#if QT_CONFIG(whatsthis)
        self.Blender_lbl.setWhatsThis(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><br/></p><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.Blender_lbl.setText(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><span style=\" color:#ffffff;\">Blender</span></p></body></html>", None))
#if QT_CONFIG(whatsthis)
        self.Blender_btl.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.Blender_btl.setText("")
#if QT_CONFIG(whatsthis)
        self.unity_btn.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.unity_btn.setText("")
#if QT_CONFIG(whatsthis)
        self.unity_lbl.setWhatsThis(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><br/></p><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.unity_lbl.setText(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#if QT_CONFIG(whatsthis)
        self.gmail_lbl.setWhatsThis(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><br/></p><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.gmail_lbl.setText(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><span style=\" color:#ffffff;\">Gmail</span></p></body></html>", None))
#if QT_CONFIG(whatsthis)
        self.gmail_btn.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.gmail_btn.setText("")
#if QT_CONFIG(whatsthis)
        self.bing_lbl.setWhatsThis(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><br/></p><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.bing_lbl.setText(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><span style=\" color:#ffffff;\">Bing</span></p></body></html>", None))
#if QT_CONFIG(whatsthis)
        self.bing_btn.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.bing_btn.setText("")
#if QT_CONFIG(whatsthis)
        self.hboGo_lbl.setWhatsThis(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><br/></p><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.hboGo_lbl.setText(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><span style=\" color:#ffffff;\">HBO GO</span></p></body></html>", None))
#if QT_CONFIG(whatsthis)
        self.hboGo_btn.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.hboGo_btn.setText("")
#if QT_CONFIG(whatsthis)
        self.source_lbl.setWhatsThis(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><br/></p><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.source_lbl.setText(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><span style=\" color:#ffffff;\">Source</span></p></body></html>", None))
#if QT_CONFIG(whatsthis)
        self.source_btn.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.source_btn.setText("")
#if QT_CONFIG(whatsthis)
        self.electron_lbl.setWhatsThis(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><br/></p><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.electron_lbl.setText(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><span style=\" color:#ffffff;\">Electron</span></p></body></html>", None))
#if QT_CONFIG(whatsthis)
        self.electron_btn.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.electron_btn.setText("")
#if QT_CONFIG(whatsthis)
        self.dropBox_lbl.setWhatsThis(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><br/></p><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.dropBox_lbl.setText(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><span style=\" color:#ffffff;\">DropBox</span></p></body></html>", None))
#if QT_CONFIG(whatsthis)
        self.dropBox_btn.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.dropBox_btn.setText("")
#if QT_CONFIG(whatsthis)
        self.raspberry_lbl.setWhatsThis(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><br/></p><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.raspberry_lbl.setText(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><span style=\" color:#ffffff;\">Raspberry</span></p></body></html>", None))
#if QT_CONFIG(whatsthis)
        self.raspberry_btn.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.raspberry_btn.setText("")
#if QT_CONFIG(whatsthis)
        self.android_lbl.setWhatsThis(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><br/></p><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.android_lbl.setText(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><span style=\" color:#ffffff;\">Android</span></p></body></html>", None))
#if QT_CONFIG(whatsthis)
        self.android_btn.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.android_btn.setText("")
#if QT_CONFIG(whatsthis)
        self.directWF_lbl.setWhatsThis(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><br/></p><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.directWF_lbl.setText(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><span style=\" color:#ffffff;\">Direct W-F</span></p></body></html>", None))
#if QT_CONFIG(whatsthis)
        self.directWF_btn.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.directWF_btn.setText("")
#if QT_CONFIG(whatsthis)
        self.ios_lbl.setWhatsThis(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><br/></p><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.ios_lbl.setText(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><span style=\" color:#ffffff;\">IOS</span></p></body></html>", None))
#if QT_CONFIG(whatsthis)
        self.ios_btn.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.ios_btn.setText("")
#if QT_CONFIG(whatsthis)
        self.ibm_lbl.setWhatsThis(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><br/></p><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.ibm_lbl.setText(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><span style=\" color:#ffffff;\">IBM</span></p></body></html>", None))
#if QT_CONFIG(whatsthis)
        self.ibm_btn.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.ibm_btn.setText("")
#if QT_CONFIG(whatsthis)
        self.tesla_lbl.setWhatsThis(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><br/></p><p><span style=\" color:#ffffff;\">Unity</span></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.tesla_lbl.setText(QCoreApplication.translate("MainWindowMW", u"<html><head/><body><p><span style=\" color:#ffffff;\">Tesla</span></p></body></html>", None))
#if QT_CONFIG(whatsthis)
        self.tesla_btn.setWhatsThis("")
#endif // QT_CONFIG(whatsthis)
        self.tesla_btn.setText("")
#if QT_CONFIG(whatsthis)
